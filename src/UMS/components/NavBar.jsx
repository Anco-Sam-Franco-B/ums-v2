...
function NavBar() {
  ...
  return (
    <div className='w-[18%] overflow-hidden h-full bg-white/80 rounded-md shadow-lg p-4'>
        <h1 data-aos-delay="200" data-aos="fade-right" className='text-2xl text-blue-500 mb-3'>UM<sup className='font-semibold text-sm text-indigo-500'>System</sup></h1>
        <hr />
        <nav data-aos-delay="300" data-aos="fade-right" className='text-xs py-5 flex flex-col gap-2'>
